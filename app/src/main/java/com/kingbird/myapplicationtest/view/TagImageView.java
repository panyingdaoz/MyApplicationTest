...
public class TagImageView extends FrameLayout {
    ...
    private void initView(Context context) {
        ...
        mOvalPaint.setTextSize(PxtoSpUtils.sp2px(context, 14));
        mOvalPaint.setStrokeWidth(PxtoSpUtils.dip2px(context, 1));
        ...
        //边框与文字顶部底部的距离
        topPadding = PxtoSpUtils.dip2px(context, 3);
        leftPading = PxtoSpUtils.dip2px(context, 6);
        ...
        tagClickListener = new TagTextView.TagGestureListener() {
            ...
            public void inDeleteRect(View view, TagInfoBean bean) {
                ...
                if (mDeleteTagListener != null) {
                    mDeleteTagListener.remove(mPath, bean);
                }
            }
