package com.kingbird.myapplicationtest.widget;
...
public class ViewTooltip {
    ...
    public static class TooltipView extends FrameLayout {
        ...
        private int mBubbleColor = Color.parseColor("#828282");
        ...
        public TooltipView(Context context) {
            ...
            mPaddingTop = mPaddingBottom = resolveDimension(getContext(), R.attr.xui_tip_popup_padding_top);
            mPaddingRight = mPaddingLeft = resolveDimension(getContext(), R.attr.xui_tip_popup_padding_left);
...
//            setTextTypeFace(XUI.getDefaultTypeface());
        ...
        public void setText(String text) {
            if (mChildView instanceof TextView) {
                ((TextView) mChildView).setText(text);
                // 2020-11-15 修改为原生
